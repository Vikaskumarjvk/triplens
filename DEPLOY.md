...
2. Drag the entire `loungelens` folder onto the page.
...
2. New repository, name it `loungelens`, keep it **Public**.
...
5. Live in ~2 min at `https://YOURNAME.github.io/loungelens/`.
...
- 🔲 A custom domain (optional, ~₹800/yr) if you want `loungelens.in` instead of a `.netlify.app` link.
